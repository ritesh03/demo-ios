...
class CustomTabBar: UITabBar {
    ...
    public lazy var middleButton: UIButton! = {
        ...
        middleButton.frame.size = CGSize(width: 54, height: 54)
        
        let image = UIImage(systemName: "plus")!
        middleButton.setImage(image, for: .normal)
        middleButton.imageEdgeInsets = UIEdgeInsets(top: 15, left: 15, bottom: 15, right: 15)
        middleButton.backgroundColor = UIColor.themeColor()
    ...
    override func layoutSubviews() {
        ...
        middleButton.center = CGPoint(x: frame.width / 2, y: 15)
    }
    ...
    override func sizeThatFits(_ size: CGSize) -> CGSize {
        var size1 = super.sizeThatFits(size)
